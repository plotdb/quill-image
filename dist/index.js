...
var Embed, Delta, fit2size, attrname, getfmt, setfmt, pollpos, imagePlusBlot, resizer, ref$;
...
pollpos = {
  _: {},
  bind: function(arg$){
    var node, cb, init, ref$, this$ = this;
    node = arg$.node, cb = arg$.cb;
    init = !this._.node;
    ref$ = this._;
    ref$.node = node;
    ref$.cb = cb;
  ...
  tick: function(){
    var n, ref$, b, box, this$ = this;
    if (!(n = this._.node)) {
      return;
    }
    ref$ = [(ref$ = this._).box || (ref$.box = {}), n.getBoundingClientRect()], b = ref$[0], box = ref$[1];
